...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $post_data['cus_add1'] = $request->customer_add1;
        $post_data['cus_add2'] = $request->customer_add2;
        $post_data['cus_city'] = $request->customer_city;
        $post_data['cus_state'] = $request->customer_state;
        $post_data['cus_postcode'] = $request->customer_postcode;
    ...
    public function payViaAjax(Request $request)
    {
        ...
        $post_data['cus_state'] = "";
        $post_data['cus_postcode'] = $request->customer_postcode;
        $post_data['cus_country'] = $request->customer_county;
