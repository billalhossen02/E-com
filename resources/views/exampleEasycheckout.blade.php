        ...
        <div class="col-md-8 order-md-1">
            ...
            <form method="POST" class="needs-validation" action="{{route('paymentcheck')}}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="customer_add1" class="form-control" id="address" placeholder="93 B, New Eskaton Road"
                           value="" required>
                    <div class="invalid-feedback">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" name="customer_postcode" class="form-control" id="zip" placeholder="" required>
                        <div class="invalid-feedback">
                            Zip code required.
                        </div>
                    </div>
