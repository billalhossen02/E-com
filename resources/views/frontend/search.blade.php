        ...
        <div class="row g-2">
            ...
            <div class="col-md-4 d-flex justify-content-center">
                <div class="card p-2"  style="background-color:transparent;">
                    <div class="text-center"> <img src="{{url('image/'.$item->image)}}" class="img-fluid" width="200"/> </div>
                    <div class="content">
                       ...
                       <div class="d-flex justify-content-center"><a href={{route('payment')}}><button class="btn btn-outline-light mr-1">Buy Now</button></a> </div> 
                    </div>
                </div>
            </div>
    @endforeach
